...
import static com.general.files.OutputStreamReader.getPostDataString;
...
public class ExecuteWebServerUrl /*extends AsyncTask<String, String, String>*/ {
    ...
    public ExecuteWebServerUrl(Context mContext, String directUrl, boolean directUrl_value) {
        ...
        if (directUrl.startsWith("https://maps.googleapis.com") && ENABLE_MAPS_API_REPLACEMENT) {
    ...
    public void performPostCall() {
        if (directUrl_value && (!directUrl.startsWith("https://maps.googleapis.com") || (directUrl.startsWith("https://maps.googleapis.com") && ENABLE_MAPS_API_REPLACEMENT == false))) {
        ...
        if (parameters != null) {
            try {
                Logger.d("Parameters", "::" + getPostDataString(parameters));
                Logger.d("Url", "::" + CommonUtilities.SERVER_URL_WEBSERVICE + "" + getPostDataString(parameters));
