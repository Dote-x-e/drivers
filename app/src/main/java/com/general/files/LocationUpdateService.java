...
public class LocationUpdateService extends Service implements UpdateDriverLocation.OnDemoLocationListener {
    ...
    LocationCallback mLocationCallback = new LocationCallback() {
        ...
        public void onLocationResult(LocationResult locationResult) {
            ...
            Log.d("onLocationResult", "onLocationResult: "+Utils.SKIP_MOCK_LOCATION_CHECK);
    ...
    public void stopLocationUpdateService(Object obj) {
        try {
            ...
            if (obj != null && !(obj instanceof GetLocationUpdates)) {
    ...
    private void runAsForeground() {
        ...
        if (Build.VERSION.SDK_INT >= Build.VERSION_CODES.O) {
            mBuilder.setChannelId(getApplicationInfo().packageName);
    ...
    protected void showAppBadgeFloat(Intent intent) {
        ...
        if (!generalFunc.canDrawOverlayViews(mContext) || (iTripId.equalsIgnoreCase("") && generalFunc.retrieveValue(Utils.DRIVER_ONLINE_KEY).equals("false"))) {
            return;
        }
