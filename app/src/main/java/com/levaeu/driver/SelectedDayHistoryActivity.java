        ...
        if (isDataAvail) {
            ...
            if (msgArr != null) {
                ...
                for (int i = 0; i < msgArr.length(); i++) {
                    ...
                    ((MTextView) customView.findViewById(R.id.timeTxt)).setText(generalFunc.getDateFormatedType(generalFunc.getJsonValueStr("tTripRequestDateOrig", obj_temp), Utils.OriginalDateFormate, Utils.dateFormateTimeOnly));
                    ...
                    boolean eFly=generalFunc.getJsonValueStr("eFly", obj_temp).equalsIgnoreCase("Yes");
                    ((MTextView) customView.findViewById(R.id.typeTxt)).setText(eFly?generalFunc.retrieveLangLBl("","LBL_HEADER_RDU_FLY_RIDE"):generalFunc.getJsonValueStr("vServiceTitle", obj_temp));
