 ...
 */
public class MyHeatViewActivity extends AppCompatActivity implements OnMapReadyCallback, GoogleMap.OnCameraChangeListener, GetLocationUpdates.LocationUpdatesListener {
        ...
        exeWebServer.setDataResponseListener(new ExecuteWebServerUrl.SetDataResponse() {
            ...
            public void setResponse(String responseString) {
                ...
                if (responseStringObject != null && !responseStringObject.equals("")) {
                    ...
                    if (isDataAvail == true) {
                        JSONArray dataLocArr = generalFunc.getJsonArray(Utils.message_str, responseStringObject);
                        ...
                        for (int i = 0; i < dataLocArr.length(); i++) {
                            ...
                            double lat = generalFunc.parseDoubleValue(0.0, generalFunc.getJsonValueStr("Latitude", obj_temp));
                            double longi = generalFunc.parseDoubleValue(0.0, generalFunc.getJsonValueStr("Longitude", obj_temp));
