    ...
    public void addContact(String contactName, String contactPhone) {
        ...
        exeWebServer.setDataResponseListener(new ExecuteWebServerUrl.SetDataResponse() {
            ...
            public void setResponse(String responseString) {
                ...
                if (responseString != null && !responseString.equals("")) {
                    Logger.d("responseString", "responseString:" + responseString);
            ...
            if (uri != null) {
                ...
                try {
                    ...
                    if (c != null && c.moveToFirst()) {
                        ...
                        Logger.d("Cursor Object", "::" + DatabaseUtils.dumpCursorToString(c));
                        Logger.d("number ", "::" + number);
                        Logger.d("number ", "::" + c.getString(c.getColumnIndex(ContactsContract.CommonDataKinds.Phone.DISPLAY_NAME)));
