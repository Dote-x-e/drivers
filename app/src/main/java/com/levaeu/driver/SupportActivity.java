...
public class SupportActivity extends AppCompatActivity {
    ...
    private void initView() {
        ...
        if (generalFunc.getJsonValueStr("ENABLE_LIVE_CHAT", userProfileJsonObj).equalsIgnoreCase("Yes")) {
    ...
    private void startChatActivity() {
        ...
        String driverName = generalFunc.getJsonValueStr("vName", userProfileJsonObj) + " " + generalFunc.getJsonValueStr("vLastName", userProfileJsonObj);
        String driverEmail = generalFunc.getJsonValueStr("vEmail", userProfileJsonObj);

        Utils.LIVE_CHAT_LICENCE_NUMBER = generalFunc.getJsonValueStr("LIVE_CHAT_LICENCE_NUMBER", userProfileJsonObj);
        HashMap<String, String> map = new HashMap<>();
        map.put("FNAME", generalFunc.getJsonValueStr("vName", userProfileJsonObj));
        map.put("LNAME", generalFunc.getJsonValueStr("vLastName", userProfileJsonObj));
        map.put("EMAIL", generalFunc.getJsonValueStr("vEmail", userProfileJsonObj));
