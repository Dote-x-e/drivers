        ...
        exeWebServer.setDataResponseListener(responseString -> {
            ...
            if (responseStringObject != null && !responseStringObject.equals("")) {
                ...
                if (isDataAvail == true) {
                    ...
                    generalFunc.storeData(Utils.languageLabelsKey, generalFunc.getJsonValueStr(Utils.message_str, responseStringObject));
                    generalFunc.storeData(Utils.LANGUAGE_IS_RTL_KEY, generalFunc.getJsonValueStr("eType", responseStringObject));
