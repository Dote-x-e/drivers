...
//            selectionDividerField.set(amPmNumberPicker, getResources().getDrawable(R.drawable.selection_divider));
            ...
            Logger.d(TAG, "ClassNotFoundException in CustomTimePicker" + e.toString());
        } catch (NoSuchFieldException e) {
            Logger.d(TAG, "NoSuchFieldException in CustomTimePicker" + e.toString());
        } catch (IllegalAccessException e) {
            Logger.d(TAG, "IllegalAccessException in CustomTimePicker" + e.toString());
        } catch (IllegalArgumentException e) {
            Logger.d(TAG, "IllegalArgumentException in CustomTimePicker" + e.toString());
        }
    }
}
