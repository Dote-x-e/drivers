...
import com.levaeu.driver.MyWalletHistoryActivity;
            ...
            public void setResponse(String responseString) {
                ...
                if (responseStringObj != null && !responseStringObj.equals("")) {
                    ...
                    if (generalFunc.checkDataAvail(Utils.action_str, responseStringObj) == true) {
                        ...
                        JSONArray arr_transhistory = generalFunc.getJsonArray(Utils.message_str, responseStringObj);
                        ...
                        if (arr_transhistory != null && arr_transhistory.length() > 0) {
                            for (int i = 0; i < arr_transhistory.length(); i++) {
                                ...
                                map.put("tDescriptionConveretd",generalFunc.convertNumberWithRTL(tDescription));
                                ...
                                map.put("listingFormattedDate", generalFunc.getDateFormatedType(dDateOrig, Utils.OriginalDateFormate, Utils.dateFormateInList));
                        ...
                        String LBL_BALANCE = generalFunc.getJsonValueStr("user_available_balance", responseStringObj);
                        ...
                        if (list.size() == 0) {
                            removeNextPageConfig();
                            noTransactionTxt.setText(generalFunc.retrieveLangLBl("", generalFunc.getJsonValueStr(Utils.message_str, responseStringObj)));
